...
1. [Pull up registors - SparkFun](https://learn.sparkfun.com/tutorials/pull-up-resistors)
...
1. [BJT as Amplifier - Youtube](https://www.youtube.com/watch?v=3YAmmUE-0jA&index=2&list=PLnXZKd8Bt9_7t1pY-HC_E7Ysfcddc6yQO)
2. [BJT as Switch - Youtube](https://www.youtube.com/watch?v=rOG8rabizcM&index=4&list=PLnXZKd8Bt9_7t1pY-HC_E7Ysfcddc6yQO)

### Logic Level ###

1. [Logic Level - SparkFun](https://learn.sparkfun.com/tutorials/logic-levels)

### Analog to Digital Conversion ###

1. [ADC - Arduino Playground](http://playground.arduino.cc/CourseWare/AnalogInput)
2. [ADC - SpurkFun](https://learn.sparkfun.com/tutorials/analog-to-digital-conversion)

### Pulse Width Modulation ###

1. [PWM - SparkFun](https://learn.sparkfun.com/tutorials/pulse-width-modulation)

### Shift Registers ###

1. [Shift Registers - SparkFun](https://learn.sparkfun.com/tutorials/shift-registers)
